...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{package_overview_witharrows.png}
...
\begin{figure*}[htb]
    \centering
    \includegraphics[width=\textwidth]{horizon_distance_chirp_mass.pdf}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=\columnwidth]{role_eccentricity.pdf}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\columnwidth]{merger_time_contours.pdf}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\columnwidth]{detector_sc_compare.pdf}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\columnwidth]{detector_snr_ratio.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{snr_over_time.pdf}
